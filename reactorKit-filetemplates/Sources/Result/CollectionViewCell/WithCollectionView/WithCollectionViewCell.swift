...
final class WithCollectionViewListCell: BaseCollectionViewCell, ReactorKit.View {

    // MARK: Typealias

    typealias Reactor = WithCollectionViewListCellReactor
...
extension WithCollectionViewListCell {
...
extension WithCollectionViewListCell: UICollectionViewDelegateFlowLayout {
    func collectionView(
